...
public class SimpleTests
{
    ...
    {
        var box1 = new Box(0, 0f, 0f, 5f, 5f);
        var box2 = new Box(1, 0f, 0f, 5f, 5f);
    ...
    {
        var box1 = new Box(0, 0f, 0f, 1f, 1f);
        var box2 = new Box(1, 1f, 1f, 1f, 1f);
        Assert.That(Box.Intersects(box1, box2), Is.True);
    }
    ...
    {
        var box1 = new Box(0, 0f, 0f, 1f, 1f);
        var box2 = new Box(1, -0.5f, 0f, 1f, 1f);
        Assert.That(Box.Intersects(box1, box2), Is.True);
    }
    ...
    {
        var box1 = new Box(0, 0f, 0f, 1f, 1f);
        var box2 = new Box(1, -1.5f, 0f, 1f, 1f);
    ...
    {
        var box1 = new Box(0, 0f, 0f, 1f, 1f);
        var box2 = new Box(1, 0f, 0.5f, 1f, 1f);
        Assert.That(Box.Intersects(box1, box2), Is.True);
    }
    ...
    {
        var box1 = new Box(0, 0f, 0f, 1f, 1f);
        var box2 = new Box(1, 0f, 1.1f, 1f, 1f);
        Assert.That(Box.Intersects(box1, box2), Is.False);
    }
